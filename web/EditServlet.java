...
public class EditServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		StudentModel studentModel = new StudentModel(Integer.parseInt(student_id), firstName.trim(), middleName.trim(),
				lastName.trim(), branch.trim(), Integer.valueOf(maths), Integer.valueOf(english),
