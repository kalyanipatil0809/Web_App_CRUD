...
<body>
	<center>
		...
		<h1><a href="index.jsp">Add New Student</a></h1>
	</center>
	<table border='1' cellpadding="8" width='100%' cellpadding="5">
		<tr>
			<th>Student ID</th>
			<th>First Name</th>
			<th>Middle Name</th>
		...
		<c:forEach var="student" items="${studentModel}">
			<tr>
				...
				<td><a href="/StudentWebApp/EditServlet?student_id=<c:out value='${student.student_id}'/>">Edit</a>
				<td><a onclick="onDelete()"href="/StudentWebApp/DeleteServlet?student_id=<c:out value='${student.student_id}'/>">Delete</a>
			</tr>
		</c:forEach>
	</table>
	<script>
